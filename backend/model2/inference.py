#!/usr/bin/env python3
"""
Inference pipeline for defect detection model (model2)
...
class DefectDetectionInference:
    def __init__(self, model_path: str, confidence_threshold: float = 0.25, 
                 device: str = 'auto'):
        """
        Initialize defect detection inference pipeline.
        ...
        # Load model
        print(f"Loading defect detection model from: {model_path}")
    ...
    def predict_single(self, image_path: str, save_result: bool = True, 
        ...
        if result.boxes is not None:
            ...
            for i, (box, conf, cls) in enumerate(zip(boxes, confidences, classes)):
                # Map class IDs to class names (6 classes)
...
def main():
    ...
    inference = CrackDetectionInference(
