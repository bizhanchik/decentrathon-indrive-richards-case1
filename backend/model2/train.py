...
class YOLOTrainer:
    ...
    def train(self, resume: bool = False, pretrained_weights: str = None, workers: int = 8) -> str:
        ...
        try:
            ...
            run_dir = self.runs_dir / 'train' / 'model2'
...
def main():
    ...
    parser.add_argument('--data', type=str, default='data2_extracted/data.yaml',
    ...
    parser.add_argument('--project', type=str, default='car_damage_detection_model2',
    ...
    if not data_path.exists():
        ...
        print("Please ensure data2_extracted exists with the full 6-class dataset")
        return
