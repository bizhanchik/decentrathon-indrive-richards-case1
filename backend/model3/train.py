#!/usr/bin/env python3
"""
YOLOv8 training script for car defect detection - Model 3.
Supports GPU/CPU training, checkpointing, and resume capability.
Trained on data3 with classes: damaged-dent, damaged-scratch, good_condition, severe damage
"""
...
class YOLOTrainer:
    def __init__(self, data_yaml_path: str, model_size: str = 'n', 
                 ...
                 checkpoint_interval: int = 5, project_name: str = 'car_defect_detection_model3'):
        """
        Initialize YOLO trainer for Model 3.
        ...
        # Setup paths - use centralized runs directory
        self.project_root = Path(__file__).parent.parent.parent  # Go up to main project root
        ...
        print(f"=== YOLOv8 Car Defect Detection Training - Model 3 ===")
    ...
    def train(self, resume: bool = False, pretrained_weights: str = None, workers: int = 8) -> str:
        ...
        try:
            ...
            run_dir = self.runs_dir / 'train' / 'model3'
...
def main():
    parser = argparse.ArgumentParser(description='Train YOLOv8 for car defect detection - Model 3')
    parser.add_argument('--data', type=str, default='data3_extracted/data.yaml',
    ...
    parser.add_argument('--project', type=str, default='car_damage_detection_model3',
    ...
    if not data_path.exists():
        ...
        print("Please ensure data3_extracted exists with the 4-class dataset")
        return
