#!/usr/bin/env python3
"""
Preprocessing pipeline for data3.zip - Car Damage Detection
Processes dataset with classes: damaged-dent, damaged-scratch, good_condition, severe damage
"""
...
def process_data3_dataset(source_dir, output_dir):
    """
    Process data3 dataset and prepare it for training
    
    Args:
        source_dir: Path to extracted data3 directory
...
def main():
    parser = argparse.ArgumentParser(description='Preprocess data3 for car damage detection')
    parser.add_argument('--source', default='data3_extracted', 
                       help='Source directory containing extracted data3')
    parser.add_argument('--output', default='data3_processed',
    ...
    print(f"Processing data3 dataset from {source_dir} to {output_dir}")
    stats, class_stats = process_data3_dataset(source_dir, output_dir)
