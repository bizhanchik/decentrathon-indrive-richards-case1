#!/usr/bin/env python3
"""
YOLOv8 training script for car defect detection - Model 4.
Supports GPU/CPU training, checkpointing, and resume capability.
Trained on data4 with classes: Dent, Dislocation, Scratch, Shatter, damaged, severe damage
"""
...
class YOLOTrainer:
    def __init__(self, data_yaml_path: str, model_size: str = 'n', 
                 ...
                 checkpoint_interval: int = 5, project_name: str = 'car_defect_detection_model4'):
        """
        Initialize YOLO trainer for Model 4.
        ...
        print(f"=== YOLOv8 Car Defect Detection Training - Model 4 ===")
    ...
    def train(self, resume: bool = False, pretrained_weights: str = None, workers: int = 8) -> str:
        ...
        try:
            ...
            run_dir = self.runs_dir / 'train' / 'model4'
...
def main():
    parser = argparse.ArgumentParser(description='Train YOLOv8 for car defect detection - Model 4')
    parser.add_argument('--data', type=str, default='data4_extracted/data.yaml',
    ...
    parser.add_argument('--project', type=str, default='car_damage_detection_model4',
    ...
    if not data_path.exists():
        ...
        print("Please ensure data4_extracted exists with the 6-class dataset")
        return
