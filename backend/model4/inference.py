#!/usr/bin/env python3
"""
Inference pipeline for car damage detection model (model4)
Supports single image, batch processing, and real-time inference
Detects: damaged, good_condition
"""
...
class CarDamageDetectionInference:
    def __init__(self, model_path: str, confidence_threshold: float = 0.25, 
        ...
        # Data4 classes - actual trained classes from data.yaml
        self.class_names = ['Dent', 'Dislocation', 'Scratch', 'Shatter', 'damaged', 'severe damage']
...
def main():
    parser = argparse.ArgumentParser(description='Car Damage Detection Inference (Model4)')
