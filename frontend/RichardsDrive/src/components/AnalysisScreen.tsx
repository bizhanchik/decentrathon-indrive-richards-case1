            ...
            {isAnalyzing ? (
              ...
              results && (
                <div className="space-y-6 animate-fade-in">
                  ...
                  {/* AI-Repaired Preview */}
                      {'gemini_analysis' in results && results.gemini_analysis?.damage_detected && results.gemini_analysis?.repaired_image && (
                        <Card className="bg-[#2c2c2c] border-black animate-fade-in">
                          ...
                          <CardContent>
                            ...
                            <div className="relative rounded-xl overflow-hidden bg-[#1a1a1a] border border-[#c1f21d]/20">
                              <img
                                src={`data:image/jpeg;base64,${'gemini_analysis' in results ? results.gemini_analysis.repaired_image : ''}`}
